...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>FetchMultipleItems</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>UserInfoDetails</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
        <editable>true</editable>
        <field>Checklist2__c.Picklist2__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Checklist2__c.status__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>Checklist2__c-Checklist2 Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Checklist2__c-Checklist2 Layout</layout>
        <recordType>Checklist2__c.ChecklistRecords</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Checklist2__c-Checklist2 Layout</layout>
        <recordType>Checklist2__c.ChecklistTitle</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ChecklistTitle__c-ChecklistTitle Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ChecklistTitle__c-ChecklistTitle Layout</layout>
        <recordType>ChecklistTitle__c.ChecklistTitleName</recordType>
    </layoutAssignments>
    <objectPermissions>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>ChecklistTitle__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    ...
    <tabVisibilities>
        <tab>Checklist2__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
        <tab>ChecklistTitle__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
